...
import { EARTH_RADIUS } from '../../js/constants.js'
...
// Earth
const OPTIONS = {
  radius: EARTH_RADIUS, // the radius of the earth
...
async function mounted () {
  ...
  //   new THREE.SphereBufferGeometry(OPTIONS.radius * 0.8, 32, 32),
  ...
  // manager.add({
  //   mesh: placeholder,
  //   render (time, { mesh, stop }) {
  //     // console.log(time)
  //     const fac = (Math.sin(time / 500) / 10) + 1
  //     // console.log(fac)
  //     mesh.scale.set(fac, fac, fac)
  //     if (time > 3000) {
  //       mesh.visible = false
  //       stop()
  //     }
